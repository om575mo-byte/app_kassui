...
def predict(features_dict):
    ...
    model_7d_path = os.path.join(base_dir, '../models/naruko_rf_7d.pkl')
    model_28d_path = os.path.join(base_dir, '../models/naruko_rf_28d.pkl')
    model_60d_path = os.path.join(base_dir, '../models/naruko_rf_60d.pkl')
    model_90d_path = os.path.join(base_dir, '../models/naruko_rf_90d.pkl')
